      ...
      <div className="max-w-md w-full">
        <Card className="overflow-hidden">
          ...
          <div className="bg-primary px-6 py-8 text-center">
            ...
            <h1 className="text-2xl font-bold text-primary-foreground">{group.name}</h1>
            {group.description && (
              <p className="text-primary-foreground/70 mt-2 text-sm">{group.description}</p>
            )}
          ...
          <CardContent className="p-6">
            ...
            {error && (
              <p className="text-destructive text-sm bg-destructive/10 px-3 py-2 rounded-lg mb-4">{error}</p>
            )}
